...
//
// This file lowers the AISLE GEMM Operator to AISMEM dialect.
//
//===----------------------------------------------------------------------===//
...
#define DEBUG_TYPE "AISLEToAISMEM_GEMM"
...
struct AISMEMGEMMOpLowering : public ConversionPattern {
  ...
  LogicalResult matchAndRewrite(Operation *op, ArrayRef<Value> operands,
    ...
    tblgen_attrs.push_back(::mlir::NamedAttribute(
        oldOp.getTransAAttrName(), oldOp.getTransAAttr()));
    tblgen_attrs.push_back(::mlir::NamedAttribute(
        oldOp.getTransBAttrName(), oldOp.getTransBAttr()));
